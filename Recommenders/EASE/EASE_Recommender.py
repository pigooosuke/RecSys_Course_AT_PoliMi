...
class EASE_Recommender(BaseItemSimilarityMatrixRecommender):
    """EASE_Recommender
    ...
    RECOMMENDER_NAME = "EASE_Recommender"

    def __init__(self, URM_train, sparse_threshold_quota=None):
        super(EASE_Recommender, self).__init__(URM_train)
    ...
    def fit(self, topK=None, l2_norm=1e3, normalize_matrix=False, verbose=True):
        ...
        similarity = Compute_Similarity(
            self.URM_train, shrink=0, topK=self.URM_train.shape[1], normalize=False, similarity="cosine"
        )
    ...
    def load_model(self, folder_path, file_name=None):
        super(EASE_Recommender, self).load_model(folder_path, file_name=file_name)
