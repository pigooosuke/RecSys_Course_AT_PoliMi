...
def split_train_in_two_cold_items(URM_all, ICM_list=None, train_item_percentage=0.1, train_interaction_percentage=None):
    ...
    assert (
        train_item_percentage >= 0.0 and train_item_percentage <= 1.0
    ), "train_item_percentage must be a value between 0.0 and 1.0, provided was '{}'".format(train_item_percentage)
